...
[![Tests](https://img.shields.io/github/workflow/status/arithmetic-type/uint32/ci:cover?event=push&label=tests)](https://github.com/arithmetic-type/uint32/actions/workflows/ci:cover.yml?query=branch:main)
